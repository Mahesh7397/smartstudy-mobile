...
const CalculatorScreen = (navigation) => {
  ...
  const { setmenustate }=useSupplayContext()
  ...
  return (
    <>
      ...
      <GradeStack.Navigator screenOptions={{
        ...
        tabBarStyle: {
          width: '100%', height: 55, justifyContent: 'space-evenly', alignItems: "center", backgroundColor: theme.colors.background, elevation: 0,
          shadowOpacity: 0,
        },
