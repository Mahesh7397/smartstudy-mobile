  ...
  return (
      ...
      <View style={{width:'100%',height:'20%',justifyContent:'center',alignItems:'center'
           ...
           justifyContent:'center',alignItems:'center'}]}>
             ...
             <Text style={[styles.instructionText,{color:theme.colors.text,textAlign:'center'}]}>
               Next by setting your study{'\n'}
               <Text style={styles.highlight}>goals & reminders</Text>
             </Text>
           </View>
     ...
     <View style={{width:'100%',height:'20%',alignItems:'center',justifyContent:'center'}}>
           ...
           {/* Next Button */}
             ...
             <TouchableOpacity style={[styles.button,{backgroundColor:theme.dark?"#101327":"#184473"}]} onPress={()=>navigation.navigate('pagethree')}>
