import { Modal, StyleSheet, Text, View, Pressable, TextInput, Platform, Image, Alert, KeyboardAvoidingView, Keyboard, ScrollView } from 'react-native'
    ...
    return (
        <Modal visible={viewlogin} transparent={true} onRequestClose={() => { setviewlogin(false) }} animationType='slide'>
            ...
            <KeyboardAvoidingView
                ...
                style={{ flex: 1 }}>
                <View style={{
                    flex: 1, position: 'absolute', bottom: 0, top:isKeyboardVisible?'10%':'30%', right: 0, left: 0, backgroundColor: theme.colors.Modal, borderTopLeftRadius: 14, borderTopRightRadius: 14, justifyContent: 'space-evenly',
                    alignItems: 'center',
                    zIndex:10000
                }}>
                    ...
                    <View style={styles.loginbox}>
                        <View style={styles.inputbox}>
                            <Text style={{ color: theme.colors.text, fontSize: RFValue(16), fontFamily: Fonts.Roboto, fontWeight: 'bold', width: '85%', textAlign: 'left' }}>Email</Text>
                            <TextInput style={{
                        ...
                        <View style={styles.inputbox}>
                            <Text style={{ color: theme.colors.text, fontSize: RFValue(16), fontFamily: Fonts.Roboto, fontWeight: 'bold', width: '85%', textAlign: 'left' }}>Password</Text>
                            <TextInput style={{
                                width: '85%', borderColor: '#bcc1ca', borderWidth: 1, backgroundColor: theme.dark ? theme.colors.Modal : '#ffffff', height: 46, borderRadius: 12, fontSize: 20, fontFamily: Fonts.Roboto, fontWeight: 'regular', paddingHorizontal: 10, shadowColor: 'black',
                                shadowOffset: { width: 2, height: 2 },
                                shadowOpacity: 0.5,
                            ...
                            <Pressable onPress={() => {
                                ...
                                <Text style={{
                                    color: "#2148a5", fontSize: 16, fontFamily: Fonts.Roboto, fontWeight: 'regular', padding: 5,
                                    margin: 5
                                }}>Forgot your password?</Text>
                            </Pressable>
                        </View>
                        <View style={{ justifyContent: 'space-around', alignItems: 'center', height: '50%' }}>
                            <Pressable style={[styles.email_sigin, { backgroundColor: disable ? '#f3f4f6' : '#ffffff' }, , disable ? null : {
                                ...
                                shadowRadius: 3,
                                elevation: 5
                            }]} disabled={disable} onPress={() => Handlelogin()}>
                                <Text style={{ color: disable ? '#9095A0' : '#000000', fontFamily: Fonts.Roboto, fontSize: RFValue(14), fontWeight: '800', textAlign: 'center', paddingHorizontal: 4 }}>Login</Text>
                            </Pressable>
