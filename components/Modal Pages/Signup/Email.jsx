        ...
        <Modal visible={emailview} transparent={true} onRequestClose={() => { setemailview(false) }} animationType='slide'>
            ...
            <View style={{
                ...
                <View style={styles.inputbox}>
                    ...
                    <TextInput style={{ width: 350, borderColor: '#bcc1ca', borderWidth: 1, backgroundColor: theme.dark?theme.colors.Modal:'#ffffff', height: 46, borderRadius: 12, fontSize: 20, fontFamily: Fonts.Roboto, fontWeight: 'regular', paddingVertical: 5 ,shadowColor: 'black',
                ...
                <View style={styles.google}>
                    <Pressable style={[styles.google_login,{backgroundColor:theme.dark?theme.colors.Modal:'#ffffff'}]} onPress={() => {setemailview(false);onGoogleButtonPress()}}>
